...
//     <>
//       {/* Hero Section */}
//       <div className="min-h-screen bg-linear-to-r from-pink-50 to-rose-50 flex items-center justify-center">
...
//             <div className="bg-linear-to-br from-pink-200 to-rose-300 rounded-2xl h-96 flex items-center justify-center">
...
//       {/* Timeline Section */}
//       <div className="py-20 bg-linear-to-r from-pink-50 to-rose-50">
//         <div className="max-w-6xl mx-auto px-8">
...
//               <div className="shrink-0 w-24 h-24 bg-pink-500 rounded-full flex items-center justify-center text-white font-bold text-xl">
//                 2018
//               </div>
...
//             {/* Timeline Item 2 */}
//             <div className="flex gap-8 items-start">
//               <div className="shrink-0 w-24 h-24 bg-rose-500 rounded-full flex items-center justify-center text-white font-bold text-xl">
//                 2020
//               </div>
//               <div className="grow pt-2">
...
//       {/* CTA Section */}
//       <div className="py-20 bg-linear-to-r from-pink-500 to-rose-500">
    ...
    <>
            ...
            <div>
              ...
              <button 
               onClick={handleShopNow}
                className="flex items-center gap-2 text-white bg-pink-500 hover:bg-pink-600 transition px-8 py-3 rounded-full font-semibold"
              >
                Explore Our Collections
                <GoArrowUpRight />
              </button>
      ...
      <div className="py-20 bg-linear-to-r from-pink-500 to-rose-500">
        <div className="max-w-4xl mx-auto px-8 text-center text-white">
          ...
          <button 
            onClick={handleShopNow}
            className="flex items-center justify-center gap-2 mx-auto text-pink-500 bg-white hover:bg-gray-100 transition px-8 py-3 rounded-full font-semibold"
          >
            Shop Now 
            <GoArrowUpRight />
          </button>
